! function(e) {
    ...
    }), e("nav#dropdown").meanmenu({ siteLogo: "<div class='mobile-menu-nav-back'><a href='bepphuot.html' class='logo-mobile'><img src='img/logo.png'/></a></div>" }), (new WOW).init(), e.scrollUp({ scrollText: '<i class="fa fa-angle-double-up"></i>', easingType: "linear", scrollSpeed: 900, animation: "fade" }), e("#wrapper").on("click", "#side-menu-trigger a.menu-bar", function(a) {
        a.preventDefault();
        var t = e(this),
